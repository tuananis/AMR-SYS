...
const int sensorIn = 34;      // Output pin
int mVperAmp = 100;           // Used 20A therefore, Per AMP Variable set to 100(189 for 5A version of the ACS712 -use 100 for 20A Module and 66 for 30A Module)
int Watt = 0;
double Voltage = 0;
double VRMS = 0;
double AmpsRMS = 0;
