...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add - User Information</h4>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="password_hash">Password Hash <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-password_hash"  value="<?php  echo $this->set_field_value('password_hash',""); ?>" type="password" placeholder="Enter Password Hash" maxlength="255"  required="" name="password_hash"  class="form-control  password password-strength" />
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                <input id="ctrl-password_hash-confirm" data-match="#ctrl-password_hash"  class="form-control password-confirm " type="password" name="confirm_password" required placeholder="Confirm Password" />
                                                                <div class="input-group-append cursor-pointer btn-toggle-password">
                                                                    <span class="input-group-text"><i class="fa fa-eye"></i></span>
                                                                </div>
