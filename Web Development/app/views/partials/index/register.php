                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-password_hash"  value="<?php  echo $this->set_field_value('password_hash',""); ?>" type="password" placeholder="Enter Password Hash"  required="" name="password_hash"  class="form-control  password password-strength" />
