                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="tbl_customer-customer_report-records">
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-first_name">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['first_name']; ?>" 
                                                            data-pk="<?php echo $data['customer_id'] ?>" 
                                                            data-url="<?php print_link("tbl_customer/editfield/" . urlencode($data['customer_id'])); ?>" 
                                                    ...
                                                    <td class="td-city">
                                                        <span <?php if($can_edit){ ?> data-source='<?php echo json_encode_quote(Menu :: $city); ?>' 
                                                            data-value="<?php echo $data['city']; ?>" 
                                                            data-pk="<?php echo $data['customer_id'] ?>" 
                                                            data-url="<?php print_link("tbl_customer/editfield/" . urlencode($data['customer_id'])); ?>" 
                                                            data-name="city" 
                                                    ...
                                                    <th class="td-btn">
                                                        <?php if($can_view){ ?>
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("tbl_customer/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> View
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_edit){ ?>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("tbl_customer/edit/$rec_id"); ?>">
