...
class IndexController extends BaseController{
	...
	private function login_user($username , $password_text, $rememberme = false){
		...
		if(!empty($user)){
			...
			$this->modeldata['password_hash'] = $password_hash; //update the modeldata with the password hash
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("first_name","last_name","username","password_hash","email","role"); //registration fields
